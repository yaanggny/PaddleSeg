...
if __name__ == "__main__":
    ...
    for f in tqdm(os.listdir(src_dir)[:5], desc='Gen new images', ncols=80):
        fpath = os.path.join(src_dir, f)
        if not opath.isfile(fpath) or opath.getsize(fpath) < 50*50*3*8:
            continue
